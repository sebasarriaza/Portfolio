...
function page() {
  ...
  <header className="iHeader">
    <img className="iImagen" src="./images/icon.png"/>
    <h1 className="iTitulo">Adivina la capital</h1>
  </header>

  <div className="iDivPuntuacionMaxima">
    <p id="puntuacionMaxima" className="iPuntuacionMaxima"></p>
  </div>

  <div>
    <h3 className="iElegirContinente">Elige un continente</h3>
  </div>

  <div id="empezarTestDiv" className="iDivBoton">
    <a className="iEnlaceBoton" href="game/pantalla-principal">
      <button className="iBoton" onclick="localStorage.setItem('continente', 'europa')">
        Europa
      </button>
    </a>
    <a className="iEnlaceBoton" href="game/pantalla-principal">
      <button className="iBoton" onclick="localStorage.setItem('continente', 'america')">
        América
      </button>
    </a>
    <a className="iEnlaceBoton" href="game/pantalla-principal">
      <button className="iBoton" onclick="localStorage.setItem('continente', 'asia')">
        Asia
      </button>
    </a>
    <a className="iEnlaceBoton" href="game/pantalla-principal">
      <button className="iBoton" onclick="localStorage.setItem('continente', 'oceania')">
        Oceanía
      </button>
    </a>
  </div>
